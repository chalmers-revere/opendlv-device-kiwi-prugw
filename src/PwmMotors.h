...
class PwmMotors {
 public:
  PwmMotors(std::vector<std::string>, std::vector<std::string>,
 ...
 private:
  ...
  int32_t const PRU_ADDR =
      0x4A300000;                   // Start of PRU memory Page 184 am335x TRM
  ...
  int32_t const PRU_SERVO_LOOP_INSTRUCTIONS =
      48;  // instructions per PRU servo timer loop
};
